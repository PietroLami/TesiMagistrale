  ...
  \begin{itemize}
	...
	\begin{table}[h]
		...
		\begin{tabular}{|l|l|lllllll}
			...
			$\mathsf{RegisterT}$   &    \begin{tabular}[c]{@{}l@{}}$a_1  \in \mathsf{M'} ~\lor$ \\ $ p' \in \mathsf{M'}$\end{tabular}   & \multicolumn{1}{l|}{$a_1=a_2$}            & \multicolumn{1}{l|}{}          & \multicolumn{1}{l|}{$a_1=a_2$}      & \multicolumn{1}{l|}{}      & \multicolumn{1}{l|}{}    & \multicolumn{1}{l|}{}            & \multicolumn{1}{l|}{\begin{tabular}[c]{@{}l@{}}$a_1=a_2 ~\lor$ \\ $ p'=p''$\end{tabular}}          \\ \hline
			$\mathsf{UnregisterT}$ &  \begin{tabular}[c]{@{}l@{}}$a_1  \in \mathsf{M'} ~\lor$ \\ $ p' \in \mathsf{M'}$\end{tabular}      & \multicolumn{1}{l|}{}            & \multicolumn{1}{l|}{$a_1=a_2$}          & \multicolumn{1}{l|}{}      & \multicolumn{1}{l|}{$a_1=a_2$}& \multicolumn{1}{l|}{$a_1=a_2$}    & \multicolumn{1}{l|}{$a_1=a_2$}            &                                \\ \cline{1-8}
			$\mathsf{End}$         &    \begin{tabular}[c]{@{}l@{}}$a_1  \in \mathsf{M'} ~\lor$ \\ $ p' \in \mathsf{M'}$\end{tabular}   & \multicolumn{1}{l|}{}            & \multicolumn{1}{l|}{$a_1=a_2$}          & \multicolumn{1}{l|}{}      & \multicolumn{1}{l|}{$a_1=a_2$}      & \multicolumn{1}{l|}{}    &                                  &                                \\ \cline{1-7}
	...
	Nella Tabella~\ref{tab:conflitti} sono presenti i casi in cui si verificano i conflitti, $a_1$ e $p'$ rappresentano l'atomo e il pid coinvolti da $r_1$, mentre $a_2$ e $p''$ rappresentano l'atomo e il pid coinvolto da $r_2$. $\mathsf{M'}$ rappresenta gli elementi letti nella mappa dalla regola $\mathsf{Call3}$. Le celle vuote rappresentano transizioni coiniziali che non vanno in conflitto.\\
...
\end{definition}
	\begin{example}
	Nel caso $\mathsf{RegisterT}, ~ \mathsf{UnregisterT}$ non può essere presente un conflitto quando le due transizioni sono coiniziali perché si dovrebbe avere che $a_1$ non dovrebbe appartenere alla mappa di atomi e pid per applicare $\mathsf{RegisterT}$, $a_2$ dovrebbe appartenere alla mappa di atomi e pid per poter applicare $\mathsf{UnregisterT}$ e per essere in conflitto $a_1$ dovrebbe essere uguale ad $a_2$ il che è impossibile. 
\end{example}
